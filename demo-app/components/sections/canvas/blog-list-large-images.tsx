...
export interface BlogListLargeImagesProps {
  tagline?: string
  heading?: string
}

/**
 * BlogListLargeImages Component
 *
 * A vertical list of 2 blog articles with large landscape images on top, content below.
 * Image-focused layout with full-width images.
 */
export function BlogListLargeImages({
  tagline = 'From the Blog',
  heading = 'Latest Articles',
}: BlogListLargeImagesProps) {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="space-y-12">
          ...
          <div className="space-y-6">
            <div className="aspect-[21/9] rounded-lg bg-muted/50 dark:bg-muted/30 flex items-center justify-center">
          ...
          <div className="space-y-6">
            <div className="aspect-[21/9] rounded-lg bg-foreground/90 dark:bg-foreground/80 flex items-center justify-center">
