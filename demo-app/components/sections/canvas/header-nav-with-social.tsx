...
export interface HeaderNavWithSocialProps {
...
/**
 * HeaderNavWithSocial Component
 *
 * Header with logo on left, navigation center, and social icons on right.
 * Matches header-6 layout styled with MM Design System.
 *
 * Features:
 * - Logo/brand element
 ...
 */
export function HeaderNavWithSocial({
  logo = 'canvas',
  navItems = [
    { label: 'ABOUT', href: '#' },
