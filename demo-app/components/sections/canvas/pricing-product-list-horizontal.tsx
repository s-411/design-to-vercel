...
export interface PricingProductListHorizontalProps {
  onButtonClick?: (product: string) => void
}

export function PricingProductListHorizontal({
  onButtonClick,
}: PricingProductListHorizontalProps) {
            ...
            <React.Fragment key={product.id}>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-center">
                ...
                <div className="lg:col-span-3">
                  <div className="aspect-video bg-muted/50 dark:bg-muted/30 rounded-lg flex items-center justify-center">
                    <svg
