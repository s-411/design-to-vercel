...
export interface PricingThreeColumnRibbonProps {
  onButtonClick?: (plan: string) => void
  onLearnMoreClick?: (plan: string) => void
}

export function PricingThreeColumnRibbon({
  onButtonClick,
  onLearnMoreClick,
}: PricingThreeColumnRibbonProps) {
    ...
    <div className="w-full py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
          ...
          <div className="bg-muted/20 p-8 lg:p-10 rounded-lg relative overflow-hidden">
            {/* Diagonal Ribbon */}
